...
export default function MutationDetailPage() {
  const { id } = useParams()
  const data = mockMutationData[id || "disease-1"] || mockMutationData["disease-1"]
    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <header className="border-b border-border bg-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between">
          ...
          <Link to="/results" className="flex items-center gap-2 text-primary hover:text-primary/80 transition-colors">
